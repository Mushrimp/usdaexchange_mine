...
//                ll.addView(ll1);
                ...
                category1.setTextSize(width / 40);
                category1.setText("Category:");
                tr1.addView(category1);
                TextView category = new TextView(context);
                category.setPadding(30,0,0,0);
                category.setLayoutParams(new TableRow.LayoutParams((int) (width * 0.6), TableRow.LayoutParams.WRAP_CONTENT));
