...
/**
 * Created by xianan on 9/6/16.
 */
public class page_112_deleteaccount_customer extends PageOperations {
    public static void showdeletepage_customer(final String name) {
        TableLayout tl = (TableLayout) hashelements.get("deletecustomerScrollTable");
        ...
        content.setText(R.string.l_112_DeleteAccount_Instruction_Customer_0);
