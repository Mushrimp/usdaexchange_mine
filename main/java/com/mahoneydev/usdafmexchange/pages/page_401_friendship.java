            ...
            protected void executeSuccess(JSONObject result) throws JSONException {
                ...
                if (!count.equals("0")){
                    for (int i = 0; i < allfriends.length(); i++) {
                        ...
                        RelativeLayout.LayoutParams nameprams = new RelativeLayout.LayoutParams((int)(width*0.42), RelativeLayout.LayoutParams.WRAP_CONTENT);
                        ...
                        RelativeLayout.LayoutParams btprams = new RelativeLayout.LayoutParams((int)(width*0.2), (int)(height*0.045));
                        btprams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
                        btprams.addRule(RelativeLayout.CENTER_VERTICAL);
                        message_bt.setLayoutParams(btprams);
                        message_bt.setText(res.getString(R.string.l_401_Friends_MessageButton_Label_0));
                        message_bt.setTextAppearance(context, R.style.White);
                        message_bt.setPadding(0,0,0,1);
                        message_bt.setBackgroundResource(R.drawable.button_style);
                        message_bt.setStateListAnimator(null);
                        message_bt.setTransformationMethod(null);
