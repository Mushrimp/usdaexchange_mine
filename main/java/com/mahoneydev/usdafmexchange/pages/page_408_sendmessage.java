...
public class page_408_sendmessage extends PageOperations {
    public static void preparemessage(){
        ...
        if (params.containsKey("subject"))
        {
            ...
            ((EditText)hashelements.get("subjectInput")).setText(params.get("subject"));
    ...
    public static class sendmessageListener extends ClickOnceListener {
        public sendmessageListener(View button) {
            super(button);
        }
